                      ...
                      <div class="border-b border-gray-900/10 pb-6">
                        <div class="mt-8 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                          <div class="sm:col-span-4">
                            ...
                            <div class="mt-1">
                              <div class="flex rounded-md shadow-sm ring-2 ring-inset ring-gray-300 focus-within:ring-lightBlue-300 sm:max-w-md">
                                <input value={printer.name} required type="text" name="name" id="name" autocomplete="name" class="focus:outline-none  w-full block flex-1 border-0 bg-transparent py-1.5 pl-2 text-gray-900 placeholder:text-gray-400  sm:text-sm sm:leading-6" placeholder="Từ 1-20 ký tự"/>
                              </div>
                            </div>
                          </div>
                          <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                              <div class="flex rounded-md shadow-sm ring-2 ring-inset ring-gray-300 focus-within:ring-lightBlue-300 sm:max-w-md">
                                <input value={printer.brand} required type="text" name="brand" id="brand" autocomplete="brand" class=" focus:outline-none  w-full flex-1 border-0 bg-transparent py-1.5 pl-2 text-gray-900 placeholder:text-gray-400 sm:text-sm sm:leading-6" placeholder="Từ 1-20 ký tự"/>
                              </div>
                            </div>
                          </div>
                          <div class="sm:col-span-4">
                            ...
                            <div class="mt-1">
                              <div class="flex rounded-md shadow-sm ring-2 ring-inset ring-gray-300 focus-within:ring-lightBlue-300 sm:max-w-md">
                                <input value={printer.model} required type="text" name="model" id="model" autocomplete="model" class="focus:outline-none  w-full block flex-1 border-0 bg-transparent py-1.5 pl-2 text-gray-900 placeholder:text-gray-400  sm:text-sm sm:leading-6" placeholder="Từ 1-20 ký tự"/>
                              </div>
                            </div>
                          </div>
                          <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                              <div class="flex rounded-md shadow-sm ring-2 ring-inset ring-gray-300 focus-within:ring-lightBlue-300 sm:max-w-md">
                                <input value={printer.paper}required  type="number" name="paper" id="paper" autocomplete="paper" class=" focus:outline-none  w-full flex-1 border-0 bg-transparent py-1.5 pl-2 text-gray-900 placeholder:text-gray-400 sm:text-sm sm:leading-6" placeholder="Từ 1-20 ký tự"/>
                              </div>
                            </div>
                          </div>
                          <div class="sm:col-span-3">
                            ...
                            <div class="mt-1">
                              <div class="flex rounded-md shadow-sm ring-2 ring-inset ring-gray-300 focus-within:ring-lightBlue-300 sm:max-w-md">
                                <input value={printer.day} required  type="date" name="day" id="day" autocomplete="day" class=" focus:outline-none  w-full flex-1 border-0 bg-transparent py-1.5 px-2 text-gray-900 placeholder:text-gray-400 sm:text-sm sm:leading-6" placeholder="Từ 1-20 ký tự"/>
                              </div>
                            </div>
                          </div>
                          <div class="col-span-full">
                            ...
                            <div class="mt-2">
                              <textarea value={printer.description} id="about" name="about" rows="3" class="focus:outline-none block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-2 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-lightBlue-300 sm:text-sm sm:leading-6" placeholder='Không quá 200 kí tự'></textarea>
                            </div>
                          </div>
                        ...
                        <fieldset className='mt-2 float-left'>
                            ...
                            <div class="mt-2 space-y-2">
                              <div class="flex items-center gap-x-3">
                                <input checked={printer.type==1}  required id="type1" name="type" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600"/>
                              ...
                              <div class="flex items-center gap-x-3">
                                ...
                                <label checked={printer.type==2} for="type2" class="block text-sm font-medium leading-6 text-gray-900">In màu</label>
                              </div>
                        ...
                        <fieldset className='mt-2 float-right mr-6'>
                            ...
                            <div class="mt-2 space-y-2">
                              <div class="flex items-center gap-x-3">
                                <input checked={printer.state==0} required id="state1" name="state" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600"/>
                                <label for="state1" class="block text-sm font-medium leading-6 text-gray-900">Bảo trì</label>
                              </div>
                              <div class="flex items-center gap-x-3">
                                <input checked={printer.state==1} required id="state2" name="state" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600"/>
                                ...
                                >
                                  <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    <Dialog.Title
                                      ...
                                      className="text-lg font-medium leading-6 text-gray-900"
                                    >
                                      Bạn có chắc muốn chỉnh sửa máy in này không ?
                                    </Dialog.Title>
