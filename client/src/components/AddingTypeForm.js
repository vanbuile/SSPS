...
export default function AddingTypeForm() {
    ...
    const checkboxData = [
        { id: "checkbox1",label: ".XLSX (Microsoft Excel Spreadsheet)", value: "xlsx" },
        { id: "checkbox2", label: ".PPT (Microsoft Powerpoint Presentation)", value: "ppt" },
        { id: "checkbox3", label: ".DOCX (Microsoft Word Document)", value: "docx" },
        { id: "checkbox4", label: ".TXT (Text Document)", value: "txt" },
        { id: "checkbox5", label: ".PNG (Portable Network Graphics)", value: "png" },
        { id: "checkbox6", label: ".JPEG (Joint Photographic Experts Group)", value: "jpeg" },
    ];
    ...
    return (
        <div className="ml-20 mr-20 mb-10 mt-10 bg-[#F5F5F5] rounded-[40px] pt-3 pb-4 border-2 border-[#0F6CBF] flex-1 text-center text-[30px]">
			<strong id="form-title" className="text-[#374151] text-[40px]">Danh sách các kiểu file chưa được thêm</strong>
            ...
            <div className="flex grid grid-cols-10 gap-4">
                ...
                <div id="form-button" className="col-span-2 pl-4 pr-4 flex items-center">
                    <button className="w-40 h-30 bg-[#0F6CBF] text-[#F5F5F5] p-2 rounded-md" onClick={openModal}>Thêm</button>
                </div>
            </div>
            {isModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    <div className="bg-white border-2 border-[#0F6CBF] shadow-lg">
                        ...
                        <a href={`AddType?types=${checkedValues.join(',')}`}>
